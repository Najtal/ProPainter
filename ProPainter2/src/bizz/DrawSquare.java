...
public class DrawSquare extends Drawable implements Serializable {
	...
	public DrawSquare(DrawPoint pA, DrawPoint pB, boolean filled, Color color) {
	...
	public void drawMe(Graphics g) {
		g.setColor(getColor());
		if (isFilled()) {
			g.fillRect(getTopLeftCorner().getX(), getTopLeftCorner().getY(), getWidth(), getHeight());
		} else {
			g.drawRect(getTopLeftCorner().getX(), getTopLeftCorner().getY(), getWidth(), getHeight());
		}		
	}
